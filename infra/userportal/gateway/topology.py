...
class RivUserPortalGateway(Construct):
    ...
    def __init__(self, scope: Construct, id: builtins.str, riv_stack: IVpcRivStack) -> None:
        ...
        self.rest_api = api.RestApi(self, 'UserPortal',
                                    rest_api_name='{}-UserPortal'.format(
        ...
        ssm.StringParameter(self, 'EndpointAddress',
                            parameter_name='/riv/{}/userportal/url'.format(
                                riv_stack.riv_stack_name),
    ...
    def bind_state_machines(self, state_machines: IRivUserPortalStateMachines) -> api.ProxyResource:
        ...
        self.__bind_state_machine('register-idcard', state_machines.register_with_idcard,
                                  self.models.register_idcard_request, self.models.register_response_model)  

        self.__bind_state_machine('register', state_machines.register_new_user,
                                  self.models.register_user_request, self.models.register_response_model)
        self.__bind_state_machine('update', state_machines.update_existing_user,
                                  self.models.update_user_request, self.models.update_respose_model)
        self.__bind_state_machine('auth', state_machines.auth_existing_user,
                                  self.models.auth_input_model, self.models.auth_response_model)
    ...
    def bind_start_liveness_session(self, functions: RivUserPortalFunctionSet) -> api.ProxyResource:
        ...
        integration = api.LambdaIntegration(functions.start_liveness_session.function,
                                             proxy=False,
                                            integration_responses=[
                                                api.IntegrationResponse(
                                                    status_code='200',
    ...
    '''
        resource = self.rest_api.root.add_resource(
            path_part='start-liveness-session',
            default_cors_preflight_options=api.CorsOptions(
                allow_origins=api.Cors.ALL_ORIGINS,
                allow_methods=['OPTIONS', 'GET'],
            ))
    ...
    def bind_liveness_session_result(self, functions: RivUserPortalFunctionSet) -> api.ProxyResource:
        ...
        integration = api.LambdaIntegration(functions.liveness_session_result.function,
                                            proxy=False,
                                            integration_responses=[
                                                api.IntegrationResponse(
                                                    status_code='200',
        ...
        '''
        resource = self.rest_api.root.add_resource(
            path_part='liveness-session-result',
            default_cors_preflight_options=api.CorsOptions(
                allow_origins=api.Cors.ALL_ORIGINS,
    ...
    def bind_check_userid(self, functions: RivUserPortalFunctionSet) -> api.ProxyResource:
        ...
        integration = api.LambdaIntegration(functions.check_userid.function,
                                            proxy=False,
                                            integration_responses=[
                                                api.IntegrationResponse(
                                                    status_code='200',
    ...
    def bind_extract_id_card(self, functions: RivUserPortalFunctionSet) -> api.ProxyResource:
        ...
        integration = api.LambdaIntegration(functions.extract_id_card.function,
                                            proxy=False,
                                            integration_responses=[
                                                api.IntegrationResponse(
                                                    status_code='200',
